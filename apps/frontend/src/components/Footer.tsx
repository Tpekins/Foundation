export function Footer() {
  return (
    <footer className="bg-soil text-paper py-[54px] pb-[34px]">
      <div className="w-full max-w-[1300px] px-8 md:px-[6vw] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[40px] mb-[34px] md:px-[4%]">
        ...
        <div className="flex justify-between items-center pt-6 border-t border-paper/[0.15] font-mono text-[0.7rem] text-paper/[0.6] flex-wrap gap-[10px] md:px-[4%]">
